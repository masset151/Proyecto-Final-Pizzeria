...
function PizzasComponent_div_9_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 4);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](1, "app-pizza-tarjeta", 5);
...
PizzasComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PizzasComponent, selectors: [["app-pizzas"]], decls: 10, vars: 1, consts: [[1, "col-md-3", "col-sm-12"], [1, "btn", "btn-danger", 3, "click"], ["fXLayout", "row wrap", "fxLayout.xs", "column", "fxLayoutAlign", "center", "fxLayoutGap", "20px"], ["fxFlex", "20", "fxFlex.lg", "15", "fxFlex.sm", "30", 4, "ngFor", "ngForOf"], ["fxFlex", "20", "fxFlex.lg", "15", "fxFlex.sm", "30"], [3, "pizza"]], template: function PizzasComponent_Template(rf, ctx) { if (rf & 1) {
...
MenuComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MenuComponent, selectors: [["menu"]], decls: 2, vars: 1, consts: [[1, "nav", "nav-pills", "nav-fill"], ["class", "nav-item nav-link active", "routerLinkActive", "active", 3, "routerLink", 4, "ngFor", "ngForOf"], ["routerLinkActive", "active", 1, "nav-item", "nav-link", "active", 3, "routerLink"]], template: function MenuComponent_Template(rf, ctx) { if (rf & 1) {
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 5, vars: 0, consts: [[1, "row", "mt-5"], [1, "row"], [1, "col"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
const environment = {
    production: true,
    baseUrl: 'https://pizzeriasan-andres.herokuapp.com/'
};
